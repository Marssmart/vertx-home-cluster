...
import org.deer.vertx.mma.rankings.task.scenario.download.and.save.link.FighterProfileResultProcessorVerticle;
...
public class MmaRankingsVerticle extends AbstractVerticle implements DeployManager {
  ...
  public void start() throws Exception {
    deployClusterSingleton(vertx, "scrape-http-server",
        "scrape-http-server-lock",
        ScrapeHttpServerVerticle.class.getName());
